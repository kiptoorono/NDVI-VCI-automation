...
def analyze_rainfall_with_dual_sheets(
    ...
    transposed_sheet_name: str = "rainfall_zscore_analysis",
    header: bool = True,
    index_col: bool = True,
):
    # 1. Load Workbook
    ...
    # 2. Extract and Filter Year Labels (Up to 2025)
    ...
    # 3. Define the 4 Phases (LR: 9-17, SR: 18-36)
    seasons = {
        "LR_P1": (9, 13),
        "LR_P2": (14, 17),
        "SR_P1": (18, 27),
    ...
    # 5. SHEET 1: DEKAD SUMS (Horizontal style)
    ...
    # 6. SHEET 2: Z-SCORE ANALYSIS (Transposed with summary stats)
    ...
    ws_trans.append([]) # Blank separator
...
if __name__ == "__main__":
    ...
    print("Process complete. 'dekad_sums' and 'rainfall_zscore_analysis' sheets created.")